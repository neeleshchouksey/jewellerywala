...
<head>
    ...
    <link href="{{ mix('/public/assets/admin/css/laraspace.css') }}" rel="stylesheet" type="text/css">
...
<body id="app" class="maintenance-page">
    <header class="site-header">
        <a href="#" class="brand-main">
            <img src="{{asset('/public/assets/admin/img/logo-desk.png')}}" id="logo-desk" alt="Laraspace Logo" class="d-none d-md-inline ">
    ...
    <script src="{{mix('/public/assets/admin/js/core/plugins.js')}}"></script>
    @yield('scripts')
</body>
</html>
