    ...
    <div >
        ...
        <header class="header-main_area">
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="header-logo">
                                <a href="{{URL::to('/')}}">
                                    <img src="{{asset("public/")}}/assets/user/final_logo.png" alt="Hiraola's Footer Logo"
                                        ...
                                        @foreach($category as $c)
                                            <li><a href="#">{{$c->category_name}}</a>
                                                <ul class="hm-dropdown">
                                                    @foreach($c->subcategory as $s)
                                                        <li><a href="{{URL::to('/')}}/shop?sub_category={{$s->id}}">{{$s->sub_category_name}}</a>
                                                        </li>
                                                    @endforeach
                                                </ul>
                                            </li>
            ...
            <div class="offcanvas-minicart_wrapper" id="miniCart">
                <div class="offcanvas-menu-inner new-offcanvas-menu-inner" style="padding: 15px !important;">
                        ...
                        <ul class="minicart-list">
                            ...
                            <li class="minicart-product">
                                ...
                                <div class="product-item_img">
                                    <img src="{{asset("public/")}}/storage/product-images/{{$c->product_image}}">
                                </div>
                                <div class="product-item_content">
                                    <a class="product-item_title" href="shop-left-sidebar.html">{{$c->product_name}}</a>
                                    <span class="product-item_quantity">{{$c->quantity}} x <i class="fa fa-inr"> </i>{{$c->unit_price}}</span>
                                </div>
                            </li>
                                @endforeach
                        </ul>
                    ...
                    <div class="minicart-item_total">
                        <span>Subtotal</span>
                        <span class="ammount"><i class="fa fa-inr"></i>{{$total_price}}</span>
                    </div>
                    <div class="minicart-btn_area">
                        <a href="javascript:void(0);" class="hiraola-btn hiraola-btn_dark hiraola-btn_fullwidth">Go to Cart</a>
                    </div>
                    <div class="minicart-btn_area">
                        <a href="javascript:void(0);" onclick="checkout_process()" class="hiraola-btn hiraola-btn_dark hiraola-btn_fullwidth">Checkout</a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="footer-widgets_info">
                                ...
                                <div class="footer-widgets_logo">
                                    <a href="#">
                                        <img src="{{asset("public/")}}/assets/user/final_logo.png"
                                             alt="Hiraola's Footer Logo" style="width: 300px; height: 130px;">
                                    </a>
                                </div>
